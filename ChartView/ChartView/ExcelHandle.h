...
@class RowHandle,DrawNode;

@interface ExcelHandle : NSObject
...
@property (retain ,nonatomic) NSMutableArray <RowHandle *> * rowArray;
...
@property (retain ,nonatomic) NSMutableArray <DrawNode *> * titleNodes;

@property (retain ,nonatomic) NSMutableArray <DrawNode *> * headNodes;

@property (retain ,nonatomic) NSMutableArray <DrawNode *> * groupNodes;

@property (retain ,nonatomic) NSMutableArray <DrawNode *> * contentNodes;
