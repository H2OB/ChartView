...
+ (instancetype)initWithAdaptType:(AdaptType)adaptType initSize:(CGSize)initSize{
    ...
    return [[ChartHandle alloc]initWithAdaptType:adaptType initSize:initSize];
}
       ...
       || self.scaleHandle1.location == ScaleLocationRight){
        ...
        for (NSInteger index = 0; index <= scaleNum ; index ++){
            ...
            if(showScaleLine)
            {
                ...
                PathNode *node = [PathNode initWithPath:path fillColor:nil strokeColor:self.scaleHandle1.lineColor];
            ...
            if(self.scaleHandle1 && showScale)
            {
                ...
                TextNode * node = [TextNode initWithAttrString:attrString angle:self.scaleHandle1.radian size:fitSize origin:CGPointZero];
            ...
            if(self.scaleHandle2 && showScale)
            {
                ...
                TextNode * node = [TextNode initWithAttrString:attrString angle:self.scaleHandle2.radian size:fitSize origin:CGPointZero];
        ...
        [self.groupHandle.textArray enumerateObjectsUsingBlock:^(NSString * group, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            if(self.groupHandle.displayType == DisplayTypeShow)
            {
                ...
                TextNode * node = [TextNode initWithAttrString:groupString angle:self.groupHandle.radian size:fitSize center:CGPointMake(x, maxY + self.groupHandle.textFinalHeight/2.0)];
            ...
            for (NodeHandle * handle in nodeArray){
                ...
                if(handle.displayType == DisplayTypeShow || limitShow)
                {
                    ...
                    TextNode * node = [TextNode initWithAttrString:attrString angle:0 size:MAXSIZE center:textPoint];
                ...
                if ([handle isKindOfClass:[BarHandle class]]) {
                    ...
                    if (barHandle.fillColor) {
                        ...
                        PathNode * node = [PathNode initWithPath:path fillColor:barHandle.fillColor strokeColor:nil];
                    ...
                    //点
                    {
                        ...
                        if(lineHandle.outsideRadius > CGFLOAT_MIN && lineHandle.outsideColor){
                            ...
                            PathNode * node = [PathNode initWithPath:path fillColor:lineHandle.outsideColor strokeColor:nil];
                        ...
                        if(lineHandle.insideRadius > CGFLOAT_MIN && lineHandle.insideColor){
                            ...
                            PathNode * node = [PathNode initWithPath:path fillColor:lineHandle.insideColor strokeColor:nil];
...
#pragma mark - 点击事件
            ...
            if(self.tipsHandle){
                ...
                if(!self.tipsHandle.touchAction){
                    ...
                    if(isMutalbe){
                        ...
                        TextNode * node = [TextNode initWithAttrString:groupSring angle:0 size:MAXSIZE origin:CGPointMake(initX, beginY)];
                    ...
                    for (NodeHandle * handle in nodeArray) {
                        ...
                        if(!isMutalbe){
                            ...
                            TextNode *textNode = [TextNode initWithAttrString:attrString angle:0 size:MAXSIZE origin:CGPointMake(initX + width + xSpeace, beginY)];
                            ...
                            PathNode * pathNode = [PathNode initWithPath:path fillColor:handle.themeColor strokeColor:nil];
                    ...
                    TouchNode *touchNode = [TouchNode initWithNodes:tipArray touchRect:touchRect aimPoint:CGPointMake(x, aimY)];
                    ...
                    TouchNode *touchNode = [TouchNode initWithTouchRect:touchRect];
                    touchNode.idx = idx;
        ...
        for (LineHandle *line in finalArray) {
            ...
            if(line.closeArea){
                ...
                GradientNode * areaNode = [GradientNode initWithPath:areaPath];
...
#pragma mark - 刻度尺在上方/下方
        ...
        [self.groupHandle.textArray enumerateObjectsUsingBlock:^(NSString * group, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            if(self.groupHandle.displayType == DisplayTypeShow)
            {
                ...
                TextNode * node = [TextNode initWithAttrString:groupString angle:self.groupHandle.radian size:fitSize origin:CGPointZero];
            ...
            for (NodeHandle * handle in nodeArray) {
                ...
                if(handle.displayType == DisplayTypeShow || limitShow)
                {
                    ...
                    TextNode * node = [TextNode initWithAttrString:attrString angle:0 size:MAXSIZE origin:valuePoint];
            ...
            if(self.tipsHandle){
                ...
                if(!self.tipsHandle.touchAction){
                    ...
                    TouchNode *touchNode = [TouchNode initWithNodes:tipArray touchRect:touchRect aimPoint:CGPointMake(aimX, y)];
                    touchNode.contentSize = CGSizeMake(contentW, beginY - ySpeace);
                    touchNode.isRignt = self.tipsHandle.firstRight;
                    [self.contentNodes addObject:touchNode];
    ...
    if(isMutalbe && self.descHandle){
        ...
        [nodeArray enumerateObjectsUsingBlock:^(NodeHandle * handle, NSUInteger idx, BOOL * _Nonnull stop) {
            
            {
                ...
                PathNode * node = [PathNode initWithPath:path fillColor:handle.themeColor strokeColor:nil];
            ...
            }
            {
                ...
                TextNode * node = [TextNode initWithAttrString:attrString angle:0 size:MAXSIZE origin:CGPointZero];
...
- (PathNode *)lineNode{
    ...
    PathNode * node = [PathNode initWithPath:path fillColor:nil strokeColor:self.lineColor];
    return node;
